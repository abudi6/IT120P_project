...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($courseName))
		{
			...
			$query = "insert into courses (courseName,courseDescription) values ('$courseName','$courseDescription')";
		...
		{
			header("Location: content_management.php?error=Invalid Input!");
		}
	}
?>
                ...
                <div align=center>
                    ...
                    <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-field">
                                <input type="text" class="input" id="text" name="courseName" required autocomplete="off">
                                <label for="course">Course Title</label>
                            </div>
                            <div class="input-field">
                                <input type="text" class="input" id="text" name="courseDescription" required autocomplete="off">
