    ...
    <div class="main_container"> 
        ...
        <div class="container">
            ...
            <div class="grid-container">
                <a href="course_management.php" class="grid-item"><i class="fa-solid fa-book"></i>Manage Courses</a>
                <a href="add_announcement.php" class="grid-item"><i class="fa-solid fa-newspaper"></i>Add Announcement</a>
            </div>
